...
> ### 📦 本リポジトリは派生版 (Fork) です
>
> 本リポジトリ **NI_SuperBook_PDF_Converter** は、[登 大遊 (dnobori) 氏によるオリジナル「DN_SuperBook_PDF_Converter」](https://github.com/dnobori/DN_SuperBook_PDF_Converter) を Fork した派生版です。原作者の README「[8. 拡張開発されたい方へ](#8-拡張開発されたい方へ)」に記載された方針 (プルリクエストではなく Fork による派生開発) に従って公開しています。
>
> - **派生版の保守・追加開発:** JJ1BBY
...
ここから「1.4.」節は、**派生版 (Fork) の保守・追加開発者である JJ1BBY による追記**です。以降の「2.」節以下の本文は、再びオリジナル版の解説 (原作者: 登 大遊 氏) に戻ります。

本派生版は、登 大遊 氏のオリジナル版「DN_SuperBook_PDF_Converter」を Fork し、JJ1BBY が自分自身の読書環境 (特に電子ペーパー端末での読書) に合わせて追加開発したものです。オリジナル版の優れた設計・実装の上に成り立っており、原作者に深く感謝いたします。オリジナル版と同様、本派生版も [AGPLv3](LICENSE) で公開します。

以下が、Fork 時点のオリジナル版からの主な追加・変更点です。変更の詳細は、各ソースコードおよび本リポジトリのコミット履歴をご参照ください。
